...
private val OrangeDarkColorScheme = darkColorScheme(
    ...
    onTertiary = Color(0xFF442B23),
    tertiaryContainer = Color(0xFF5D3F37),
...
private val OrangeLightColorScheme = lightColorScheme(
    primary = Color(0xFFBF4B00),
    onPrimary = Color(0xFFFFFFFF),
    primaryContainer = Color(0xFFFFDBD1),
    onPrimaryContainer = Color(0xFF380F00),
    secondary = Color(0xFFA64833),
    onSecondary = Color(0xFFFFFFFF),
    secondaryContainer = Color(0xFFFFDBD1),
    onSecondaryContainer = Color(0xFF380F00),
    tertiary = Color(0xFFBF6E52),
    onTertiary = Color(0xFFFFFFFF),
